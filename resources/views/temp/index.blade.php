					...
					@else
						<div class="starting_text" style="text-align: justify;text-justify: inter-word;">
							...
							<div class="row text-center">
								<h3>Choose among the options to see information tailored to you</h3>
							</div>
								...
								{{ csrf_field() }}
										<div class="form-group">
											...
											<div class="col-xs-8">
												<select class="form-control" id="exampleSelect1" name="reason">
													<option value="tag_Student">Student</option>
													<option value="tag_Work">Work</option>
<option value="tag_SpouseStudent">Spouse of a student </option>
												</select>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<div class="col-xs-4">
												<label for="exampleSelect1" >Institute of Study</label>
											</div>
											<div class="col-xs-8">
